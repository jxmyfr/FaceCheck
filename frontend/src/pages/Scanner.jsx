  ...
  const doScan = useCallback(async (isAuto = false) => {
    ...
    try {
      ...
      if (isAuto) {
        ...
        setCooldown(true)
        setTimeout(() => { cooldownRef.current = false; setCooldown(false) }, 2000)
      }
    } catch (e) {
          ...
          <div style={{ position: 'relative', aspectRatio: '4/3', background: '#000' }}>
            ...
            {camError && (
              <div style={{
                ...
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#F87171" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/>
