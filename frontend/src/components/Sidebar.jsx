...
const HELP_ADMIN = [
  ...
  },
  {
    ...
    body: [
      'เลือกวิชาที่ต้องการเช็คชื่อ (ระบบจะล็อคคาบอัตโนมัติหากตรงเวลาปัจจุบัน)',
      'โหมด อัตโนมัติ: กด "เริ่มสแกน" แล้วให้นักเรียนเดินผ่านกล้อง ระบบสแกนทุก 2 วินาที',
      'โหมด เมนวล: กดถ่ายภาพครั้งละ 1 คน',
      'โหมด เช็คชื่อ ID: ป้อนรหัสนักเรียนโดยตรงเมื่อสแกนใบหน้าไม่ผ่าน',
...
const HELP_TEACHER = [
  ...
  },
  {
    ...
    body: [
      ...
      'โหมด เช็คชื่อ ID: ป้อนรหัสนักเรียนเมื่อสแกนใบหน้าไม่ผ่าน เลือกสถานะ มาเรียน / มาสาย / ขาดเรียน',
  ...
  },
  {
    title: 'Reports — รายงาน',
    body: [
      'ดูรายงานการเช็คชื่อเฉพาะวิชาที่คุณสอนเท่านั้น',
